...
本仓库是 [langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin) 的管理后台 WEB 端，基于 [naive-ui-admin](https://github.com/jekip/naive-ui-admin)。

**LangChain4j-AIDeepin（得应）是基于 AI 的工作效率提升工具。**
...
AIDEEPIN
  ...
  |__ 管理端WEB(langchain4j-aideepin-admin) ← 本仓库
```

代码仓库地址：[github](https://github.com/moyangzhan/langchain4j-aideepin-admin) [gitee](https://gitee.com/moyangzhan/langchain4j-aideepin-admin)

关联项目

* 后端服务 langchain4j-aideepin: [github](https://github.com/moyangzhan/langchain4j-aideepin) [gitee](https://gitee.com/moyangzhan/langchain4j-aideepin)
* 用户端WEB langchain4j-aideepin-web: [github](https://github.com/moyangzhan/langchain4j-aideepin-web) [gitee](https://gitee.com/moyangzhan/langchain4j-aideepin-web)
